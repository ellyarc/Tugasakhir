        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <body>
                    ...
                    if (isset($_GET["ubahdosen"])) {
                        $dosen_NIDN = $_GET["ubahdosen"];
...
");
                    ...
                    if (isset($_POST["Simpan"])) {
                        ...
                        // jika sedang edit (data sudah ada)
                        if (isset($_GET["ubahdosen"])) {
                            mysqli_query($conn, "
            UPDATE dosen SET
                dosen_NIK = '$dosen_NIK',
        ...
        ");
                            ...
                            // jika tambah baru
                            mysqli_query($conn, "
            INSERT INTO dosen (dosen_NIDN, dosen_NIK, dosen_Nama, dosen_Ket)
                                ...
                                <div class="row mb-3 mt-5">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nidnDSN" name="nidnDSN"
                                            ...
                                            value="<?php echo $row_edit["dosen_NIDN"] ?? ''; ?>" maxlength="10"
                                            required="">
                                    </div>
                                </div>
                                <div class="row mb-3 mt-5">
                                    <label for="nikDSN" class="col-sm-2 col-form-label">Nomor Induk Kependudukan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nikDSN" name="nikDSN"
                                            placeholder="Isikan Nomor Induk Kependudukan"
                                            value="<?php echo $row_edit["dosen_NIK"] ?? ''; ?>" maxlength="8"
                                            required="">
                                    </div>
                                </div>
                                <div class="row mb-3 mt-5">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="namaDSN" name="namaDSN"
                                            ...
                                            value="<?php echo $row_edit["dosen_Nama"] ?? ''; ?>" maxlength="30"
                                            required="">
                                    </div>
                                </div>
                                <div class="row mb-3 mt-5">

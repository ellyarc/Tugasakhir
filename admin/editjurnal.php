    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                if (isset($_GET["ubahjurnal"])) {
                    $kode = $_GET["ubahjurnal"];
                    $result = mysqli_query($conn, "SELECT * FROM jurnal WHERE jurnal_ID='$kode'");
                ...
                if (isset($_POST["Update"])) {
                    ...
                    mysqli_query($conn, "UPDATE jurnal SET
                        ...
                        jurnal_ISSN='$jurnal_ISSN',
                        jurnal_SINTA='$jurnal_SINTA',
...
$query = mysqli_query($conn, "SELECT * FROM jurnal")
    or die("Query jurnal gagal: " . mysqli_error($conn));
?>
                    ...
                    <div class="col-10">
                        <form method="POST">
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jurnalID"
                                        value="<?php echo $row['jurnal_ID']; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jurnalNama"
                                        value="<?php echo $row['jurnal_Nama']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jurnalISSN"
                                        value="<?php echo $row['jurnal_ISSN']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jurnalSinta"
                                        value="<?php echo $row['jurnal_SINTA']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-10">
                                    ...
                                    <a href="inputjurnal.php" class="btn btn-danger">Batal</a>
                                </div>
                            </div>
                        </form>
    ...
    <tr class="info">
        ...
        <?php while ($row = mysqli_fetch_array($query)) { ?>
            <tr>
                ...
                <td><a href="<?php echo $row["jurnal_URL"]; ?>" target="_blank"><?php echo $row["jurnal_URL"]; ?></a></td>
                <td>
                    <a href="editjurnal.php?ubahjurnal=<?php echo $row["jurnal_ID"] ?>" class="btn btn-success" title="EDIT">
                        <i class="bi bi-pencil-square"></i>
                    </a>
                </td>
                <td>
                    <a href="hapusjurnal.php?hapusjurnal=<?php echo $row["jurnal_ID"] ?>" class="btn btn-danger" title="HAPUS">
